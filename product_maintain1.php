    ...
    <div id="mainContents">
    	<div class="ctns member creator">
            ...
            <div class="newEdit">
                ...
                <div class="half">
                	<h4>作品名稱</h4>
                   	<input name="" type="text" placeholder="不超過20個字元，包含標點符號。" value="">
                </div>
                <div class="half">
                	<h4>預定售價</h4>
                   	<input name="" type="text" placeholder="輸入數字" value="">
                </div>
                <hr>
                <div class="quarter">
                	<h4>生產總數量</h4>
                ...
                <div class="quarter">
                	<h4>開放預購日</h4>
                   	<input name="" type="text" placeholder="yyyy-mm-dd" value="">
                </div>
                <div class="quarter">
                	<h4>截止預購日</h4>
                   	<input name="" type="text" placeholder="yyyy-mm-dd" value="">
                ...
                <div>
                	<h4>常見問答編輯</h4>
                   	<table border="0" cellpadding="0" cellspacing="0" class="commonFaqEdit">
                        ...
                        <tr>
                        	<td>1</td>
                        	<td><textarea name="" cols="" rows="" placeholder="輸入問題"></textarea></td>
                            <td><textarea name="" cols="" rows="" placeholder="輸入答案"></textarea></td>
                        </tr>
                        <tr>
                        	<td>2</td>
                        	<td><textarea name="" cols="" rows="" placeholder="輸入問題"></textarea></td>
